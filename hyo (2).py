...
# Load OpenAI API key securely from Streamlit secrets or environment variable
...
def get_ai_mentor_response(user_input):
    ...
    prompt = f"""
You are a helpful career mentor AI. Provide personalized career advice.
...
"""
    ...
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "You are an expert career mentor AI assistant."},
